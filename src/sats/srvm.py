...
class _Srvm(JavaClass, metaclass=MetaJavaClass):
    ...
    createPopulation = JavaMethod(
        '(Lorg/spectrumauctions/sats/core/model/srvm/SRVMWorld;Lorg/spectrumauctions/sats/core/util/random/RNGSupplier;)Ljava/util/List;')


    def __init__(self, seed, number_of_small_bidders=2, number_of_high_frequency_bidders=1, 
        ...
        self.setNumberOfSmallBidders(number_of_small_bidders)
        self.setNumberOfHighFrequencyBidders(number_of_high_frequency_bidders)
        self.setNumberOfSecondaryBidders(number_of_secondary_bidders)
        self.setNumberOfPrimaryBidders(number_of_primary_bidders)
    ...
    def get_efficient_allocation(self, display_output=False):
        ...
        for bidder_id, bidder in self.population.items():
            ...
            ##TODO: fix this, this does not work, it crashes here
